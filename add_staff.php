...
if (isset($_POST['add_event'])) {
    ...
    if ($valid) {
        ...
        $conn->query("INSERT INTO staff (`name`,`email`,`password`,`phone`,`address1`,`designation`,`sallary`,`file1`,`gander`,`religion`) values('$name','$email','$password','$phone','$address1','$designation','$sallary','$file1','$gander','$religion')");
        $uid = $conn->insert_id;
    ...
    <section class="main">
        <div>
            <div class="container py-4 p-md-5">
                <div class="p-3">
                    <a href="staffs.php" class="btn btn-sm text-light" style="background-color:var(--main-color)"> <i class="fas fa-arrow-left"></i> Back</a>
                </div>
                <h1 class="mb-4 text-center"> <i class='fas fa-user-plus text-success'></i> Add Staff</h1>
                <form class="row my-4 shadow border mx-auto p-3" style='max-width:630px' method="post" action="add_staff.php">
                    ...
                    <div class=" col-md-6 mt-4">
                        ...
                        <input value="<?php echo $designation; ?>" required placeholder="Enter designation.." name="designation" type="text" class="form-control rounded-0" />
                    </div>
                    <div class=" col-md-6 mt-4">
                        <label for="" class="form-label fw-bold">Sallary*</label>
                        <input value="<?php echo $sallary; ?>" required placeholder="Enter sallary staff.." name="sallary" type="text" class="form-control rounded-0" />
                    </div>
                    <div class=" col-md-6 mt-4">
                    ...
                    <div class="  mt-4">
                        ...
                        <textarea required placeholder="Enter your Address.." name="address1" class="form-control rounded-0"><?php echo $address; ?></textarea>
                    </div>
