...
if (isset($_POST['add_event'])) {
    ...
    if ($valid) {
        ...
        $conn->query("INSERT INTO users (`name`,`email`,`password`,`phone`,`address1`,`class`,`file1`,`gander`,`religion`) values('$name','$email','$password','$phone','$address1','$class','$file1','$gander','$religion')");
        $uid = $conn->insert_id;
    ...
    <section class="main">
        <div>
            <div class="container py-4 p-md-5">
                ...
                <h1 class="mb-4 text-center"> <i class='fas fa-user-plus text-success'></i> Add Students</h1>
                <form class="row my-4 shadow border mx-auto p-3" style='max-width:630px' method="post" action="add_user.php">
                    ...
                    <div class="  mt-4">
                        ...
                        <textarea required name="address1" class="form-control rounded-0"><?php echo $address; ?></textarea>
                    </div>
